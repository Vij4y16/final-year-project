...
class Smsalertlib
{
    private $user = 'santhosh021'; // write your SMSAlert Username in between ''
    private $pass = 'Smsalert@123'; // write your SMSAlert Password in between ''
    private $senderid = 'DEMOOO'; // write your Sender ID in between ''
